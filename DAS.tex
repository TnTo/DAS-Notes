...
\begin{tabular}{l|ccccccc|r}
	...
	$E$ & & $-E^{\mathcal{F}_C}_\mathcal{I}$ & $-E^{\mathcal{F}_K}_\mathcal{I}$ & $+E_\mathcal{I}$ & $-E^\mathcal{B}_\mathcal{I}$ & & & 0 \\
	$S$ & $+S_\mathcal{H}$ & & & $-S^\mathcal{I}$ & & & & 0 \\
	$K$ & & $+p_K K_{\mathcal{F}_C}$ & $+p_K K_{\mathcal{F}_K}$ & & & & & \\
	\bottomrule
\end{tabular}
