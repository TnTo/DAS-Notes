...
\begin{steps}
	...
	\item \label{F3-I2} Financial Intermediaries put sell and buy order on Equities' market, Firms emit new equities [\cref{I1,F1,F2}]
	\item \label{F4} Firms acquire Loans from Banks [\cref{F3-I2}]
