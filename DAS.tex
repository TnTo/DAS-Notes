...
\begin{tabular}{l|ccccccc|r}
	...
	$L$ & $-L_\mathcal{B}^\mathcal{H}$ & $-L_\mathcal{B}^{\mathcal{F}_C}$ & $-L_\mathcal{B}^{\mathcal{F}_K}$ & & $+L_\mathcal{B}$ & & & 0 \\
	$B$ & & & & $+D_\mathcal{B}^\mathcal{H}$ & & $+D_\mathcal{B}^\mathcal{H}$ & $+D_\mathcal{B}^\mathcal{H}$ & 0 \\
	$E$ & & & & & & & & 0 \\
	$S$ & & & & & & & & 0 \\
	$K$ & & & & & & & & \\
	\bottomrule
