...
The list is: Households ($\mathrm{H}$), Capital Goods Firms ($\mathrm{F_K}$), Consumption Goods Firms ($\mathrm{F_C}$), Financial Intermediaries ($\mathrm{I}$), Banks ($\mathrm{B}$), Government ($\mathrm{G}$), Central Bank ($\mathrm{C}$).
