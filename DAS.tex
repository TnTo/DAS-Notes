...
\section{Model steps}
\begin{steps}
	\item Every Q times, Central Bank updates interest rates [$\mathcal{C}$]
	\item Households set demand for Consumption Goods [$\mathcal{H}$]
	\item Government set target output for Public Sector Consumption Firms  [$\mathcal{G}$]
