...
\setlist[steps]{noitemsep,label=\Alph*}
...
\begin{steps}
	...
	\item \label{F1, I1} Consumption Firms set desired output and order Capital goods to Capital Firms [\cref{G1,G2}]
	...
	\item \label{G3} Government buy Public Sector Output and needed Private sector output, paying VAT [\cref{F7,G2, G1}]
	...
	\item \label{} Every Q Equities' plusvalue taxes are collected []
	\item \label{} Every Y taxes are arbitraged []
