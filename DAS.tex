...
The model includes seven different financial assets. Bank Deposits ($D_\mathcal{B}$) of Households, Firms and Financial Intermediaries. Central Bank Deposits ($D_\mathcal{C}$) of Banks and the Government. Loans ($L$) issued by the Banks to Households and Firms. Government's Bonds ($B$)
