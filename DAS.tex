...
\begin{tabular}{l|ccccccc|r}
	...
	\midrule
	$D^\mathcal{C}$ Interests & & & & & $-r_{D^\mathcal{C}} D^\mathcal{C}_\mathcal{B}$ & & $+r_{D^\mathcal{C}} D^\mathcal{C}_\mathcal{B}$& 0 \\
	$D^\mathcal{B}$ Interests &  & & & & & & & 0 \\
	$L$ Interests &  & & &  & & & & 0 \\
	$B$ Interests & & & & & & & & 0 \\
	\bottomrule
\end{tabular}
\\ \\ 
\vspace{1em}
The Consumption Goods bought by the Government are transferred to Households.
