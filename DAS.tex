...
The model includes seven different financial assets. Bank Deposits ($\mathrm{D_B}$) of Households, Firms and Financial Intermediaries. Central Bank Deposits ($\mathrm{D_C}$) of Banks and the Government. Loans ($\mathrm{L}$) issued by the Banks to Households and Firms. Government's Bonds ($\mathrm{B}$)
