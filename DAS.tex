...
The list is: Households ($\mathcal{H}$), Capital Goods Firms ($\mathrm{\mathcal{F}_K}$), Consumption Goods Firms ($\mathrm{\mathcal{F}_C}$), Financial Intermediaries ($\mathrm{\mathcal{I}}$), Banks ($\mathrm{\mathcal{B}}$), Government ($\mathrm{\mathcal{G}}$), Central Bank ($\mathrm{\mathcal{C}$).
	
\subsection{Real Assets}
The model will comprise three kind of real assets: Capital Goods ($\mathrm{K}$) and two kind of consumption goods, Essential Goods ($\mathrm{E}$) and Luxury Goods ($\mathrm{L}$).

\subsection{Financial Assets}
The model includes seven different financial assets. Bank Deposits ($\mathrm{D_B}$) of Households, Firms and Financial Intermediaries. Central Bank Deposits ($\mathrm{D_C}$) of Banks and the Government. Loans ($\mathrm{L}$) issued by the Banks to Households and Firms. Government's Bonds ($\mathrm{text}$)
