...
\begin{steps}
	...
	\litem{I2} Financial Intermediaries put sell and buy order on Equities' market, Firms emit new equities [\cref{I1,F1,F2}]
	\litem{F3} Firms acquire Loans from Banks [\cref{I2}]
	\litem{F4} Firms open job vacancies [\cref{F3}]
	\litem{H1} Households chose if enter or exit job market []
	\litem{F5} Firms hire [\cref{F4,H1}]
