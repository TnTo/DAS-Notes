...
\begin{steps}
	...
	\item \label{F1} Consumption Firms set desired output, acquire Loans from Banks [\label{C1}]
	\item \label{F2} Consumption Firms open job vacancies, order Capital goods to Capital Firms [\cref{G2, F1}]
	\item \label{F3} Capital Firms set desired output, acquire Loans from Banks [\label{C1, F2}]
