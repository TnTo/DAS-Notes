...
\begin{tabular}{|l|ccccccc|}
	\toprule
	& $\mathcal{H}$ & $\mathcal{F}_C$ & $\mathcal{F}_K$ & $\mathcal{I}$ & $\mathcal{B}$ & $\mathcal{G}$ & $\mathcal{C}$ \\
	\midrule
	$D_\mathcal{B}$ & $+D_\mathcal{B}^\mathcal{H}$ & $+D_\mathcal{B}^{\mathcal{F}_C}$ & $+D_\mathcal{B}^{\mathcal{F}_K}$ &  $+D_\mathcal{B}^\mathcal{I}$  &  $-D_\mathcal{B}$ & & \\
	$D_\mathcal{C}$ & & & & & & & \\
	$L$ & & & & & & & \\
	$B$ & & & & & & & \\
	$E$ & & & & & & & \\
