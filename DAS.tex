...
The role of Financial Intermediares in the model is only to decouple the decision on the amount to be financially invested and the actual choice of investment.
