...
Liquidity is obtained, in case of necessity, from Advances which are always granted by the Central Bank.

Banks are required to maintain at least a given liability ($D+A$) over reserves ($R$) ratio.
