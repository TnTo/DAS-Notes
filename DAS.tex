...
\begin{steps}
	...
	\item[F3I2] \label{F3-I2} Financial Intermediaries put sell and buy order on Equities' market, Firms emit new equities [\cref{I1,F1,F2}]
	\item[F4] \label{F4} Firms acquire Loans from Banks [\cref{F3I2}]
